...
export { gameTotal, targetCrossers } from './phases/game';
export { describeRetirementOffer, offSeasonOutstanding } from './phases/offSeason';
export { retireChoice } from './ai/offSeason';

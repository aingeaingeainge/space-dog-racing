...
| **v3** | `v3a`, `v3b`, `v3c`, `v3c2`, `v3d1` | **`design/GDD_V3.md` 3.0, `design/BUILD_PLAN_V3.md`** |

Last reviewed and **synced to the claude.ai Project: 24 September 2026**, at `v3d1`. The Project mirrors match this repo for `CANON.md`, `GDD_V3.md`, `BUILD_PLAN_V3.md`, `BUILD_PLAN.md` and `GDD.md`. `design/ASSET_LIST.md` is not mirrored: it is a working list for the art, read in the repo.
